 ...
 * that can `notFound()`. Checked, not assumed:/help never calls notFound() — it renders a topic list, and an empty search is a legitimate 200 with a "nothing matched" body.
 */
