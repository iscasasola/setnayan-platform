...
// host's stated budget target.
//
// Always-active rule (owner directive 2026-05-22 — "i want everything on
// home to be active now"). Supersedes the prior empty-state collapse: the
// full three-column card always renders. When no target is set, the
// "Target" column carries a "Set your budget" CTA inline so the host can
// fill it in from Settings without leaving the home page. When committed
// is zero, that column reads "₱0" with a polite "Nothing yet" hint. The
// host sees the full structure at a glance — no hidden disclosures, no
// collapsed states.
