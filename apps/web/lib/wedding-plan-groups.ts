...
export type PlanGroupTier =
  ...
  | 'extras'
  | 'paper'
  // DIY tier · added 2026-05-30 · was used for dynamic plan cells spawned
  // from Add A Category picks. The dynamic-cell helper (getCustomPlanGroups)
  // and the planning grid were retired 2026-06-28; this tier value is kept
  // for PLAN_GROUP_TIER_ORDER stability.
  | 'custom_picks';
 ...
 *
 * Consumed by todays-one-thing.ts (the CTA URL on the hero). The
 * planning-groups.tsx [Search] button (2026-06-28) and the next-steps.ts
 * (2026-05-24) consumers were both removed with their surfaces. Keeps URL
 * construction in one place so any future plan-search CTA stays in
 * lock-step with the hero.
 *
