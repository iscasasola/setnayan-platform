    ...
    items: [
      {
        ...
        body: 'Every software service you buy from Setnayan (Animated Monogram, Setnayan AI, Panood, etc.) gets an itemized receipt — emailed to you and archived in your dashboard, so you always have a record of what you paid.',
      },
      {
    ...
    items: [
      {
        ...
        body: 'Bawat software service na binili mo sa Setnayan (Animated Monogram, Setnayan AI, Panood, etc.) ay may itemized receipt — ipinapadala sa email mo at naka-archive sa dashboard mo, para may record ka lagi ng binayaran mo.',
      },
      {
        title: 'RA 10173 (Data Privacy Act) compliant',
