...
/**
 * Legacy /admin/custom-plans → studio redirect (Money split · 2026-07-10). The surface
 * now lives at /admin/pricing?tab=custom-plans; its body was re-homed into a _surfaces/*
