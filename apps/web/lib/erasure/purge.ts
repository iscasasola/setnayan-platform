 ...
 * deliberately (order_refunds · vendor_contract_signatures; see
 * tests/db/user-delete-refusing-fks.baseline.txt — a third, supplies_orders, was
 * retired along with the whole Supplies vertical, migration
