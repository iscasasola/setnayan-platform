// Ugat Studio surface — the body of the former onboarding page,
// re-homed 2026-07-10. actions/_components stay in /admin/onboarding; the legacy
...
export async function OnboardingSurface({ searchParams }: Props) {
  await requireAdmin();
