...
function TemplatesGrid({
  ...
  const swapHref = `/dashboard/${eventId}/add-ons/patiktok/booth?primary=${backup.slug}&backup=${primary.slug}`;
  return (
...
function TemplateSlot({
  ...
  const browseHref = `/dashboard/${eventId}/add-ons/patiktok?role=${role}&other=${otherSlug}`;
  return (
    <article
