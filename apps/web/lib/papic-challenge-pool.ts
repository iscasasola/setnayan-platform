...
const STORIES_SIDE: PoolRow[] = block(400, 'stories', { kind: 'clip', events: WEDDING }, [
  ...
  { title: 'What You Borrowed', prompt: 'Something of {who}’s you still have. Ten seconds. Confess.' },
...
const STORIES_ANY: PoolRow[] = block(450, 'stories', { kind: 'clip' }, [
  ...
  { title: 'What This Day Means To You', prompt: 'Ten seconds: what today means to you, honestly.' },
  ...
  { title: 'The Table You Are On', prompt: 'Ten seconds: introduce the people at your table.', mission: 'roster' },
  { title: 'How Everybody Here Connects', prompt: 'Ten seconds: explain how the people in this room know each other.' },
