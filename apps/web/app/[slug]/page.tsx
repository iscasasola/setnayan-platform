...
export default async function PublicInvitationPage({ params, searchParams }: Props) {
  ...
  // PANOOD_SYSTEM SKU is the PAID multi-camera control room + broadcast overlays
  // tier, now built at /studio/panood/broadcast. (The LIVE_WALL gate below is unchanged.)
