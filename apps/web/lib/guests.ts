...
export type GuestRow = {
  ...
  /**
   * When the couple recorded handing this guest their invitation.
   *
   * 🔑 THIS COLUMN HAD ZERO WRITERS UNTIL 2026-09-16 — the guest list's "N to
   * send" once counted it and could therefore never fall, and the count was
   * removed rather than faked. `markGuestInvitationSent` is the writer; the
