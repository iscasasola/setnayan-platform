...
BEGIN
  ...
  VALUES
    ...
    (v_event, 'Don Eduardo', 'Mercado', 'Hon. Eduardo Mercado', 'bride', 'family', 'principal_sponsor_ninong',
     FALSE, NULL, NULL,
    ...
    (v_event, 'Aurora', 'Mercado', NULL, 'bride', 'family', 'principal_sponsor_ninang',
     FALSE, NULL, NULL,
    ...
    (v_event, 'Don Ricardo', 'Dela Cruz', NULL, 'groom', 'family', 'principal_sponsor_ninong',
     FALSE, NULL, NULL,
    ...
    (v_event, 'Teresita', 'Bautista', NULL, 'groom', 'family', 'principal_sponsor_ninang',
     FALSE, NULL, NULL,
...
BEGIN
  ...
  FOR r IN
    SELECT * FROM (VALUES
      ('Eduardo','Reyes','bride','family','principal_sponsor_ninong', t_ps1, 0),
      ('Corazon','Reyes','bride','family','principal_sponsor_ninang', t_ps1, 1),
      ('Antonio','Bautista','bride','friends','principal_sponsor_ninong', t_ps1, 2),
      ('Lourdes','Bautista','bride','friends','principal_sponsor_ninang', t_ps1, 3),
      ('Ramon','Aquino','groom','family','principal_sponsor_ninong', t_ps2, 0),
      ('Teresita','Aquino','groom','family','principal_sponsor_ninang', t_ps2, 1),
      ('Fernando','Villanueva','groom','friends','principal_sponsor_ninong', t_ps2, 2),
      ('Imelda','Villanueva','groom','friends','principal_sponsor_ninang', t_ps2, 3),
