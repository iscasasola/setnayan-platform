# S9 · Venue-NAT throttle, behind an OFF flag

> **Model: Opus 5 · effort: high.** Session S9 of the controller plan `build-sessions/CONTROLLER-PLAN-2026-09-18.md`.

Follow `~/Documents/Claude/Projects/setnayan-platform/build-sessions/HANDOFF-2026-09-18/PROMPTS/P6_venue-throttle.md`. Copy `lib/join-door-throttle.ts`. The flag ships **OFF**, and the seat-claim trade (owner decision 2) is his to make, not yours. **Do not probe Cloudflare or Turnstile from this machine.** A probe can change the system it measures, and the owner's IP was flagged last time.
...
- **Your final message must end with:** `CONTROLLER ▸ S9 · <DONE|BLOCKED|NEEDS-OWNER> · PR #<n> <state> · <one line>`
