...
export async function provisionPapicSeats(formData: FormData) {
  ...
  redirect(`/dashboard/${eventId}/add-ons/papic/crew?seat_set=provisioned`);
}
...
export async function reissuePapicSeat(formData: FormData) {
  ...
  if (!seatId) {
    redirect(`/dashboard/${eventId}/add-ons/papic/crew?seat_error=missing_seat`);
  }
  ...
  revalidatePath(`/dashboard/${eventId}/add-ons/papic/crew`);
  redirect(`/dashboard/${eventId}/add-ons/papic/crew?seat_set=reissued`);
}
