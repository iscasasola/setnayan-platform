...
⏭ NOT in this change, named rather than buried: the **credits rename** reaches
further than this screen — 18 catalog titles and 17 descriptions still say
"shots" and none say "credits", plus ~300 places in app code. Half a rename shows
both words at once. And the free-credits cell **shows** the number; giving it a
save is its own change.
