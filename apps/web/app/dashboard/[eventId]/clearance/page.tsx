  ...
  */
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-6 sm:px-6">
      <PageMasthead title="Close out the day" lede={`When the celebration winds down, wrap up the live services and close out — your ${noun} dashboard then leads with the summary and the editorial maker instead of the planning tools.`} />
