    ...
    <div className="space-y-4">
      ...
      >
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center gap-1.5 rounded-xl bg-terracotta-700 px-4 py-2.5 text-sm font-semibold text-cream transition-colors hover:bg-terracotta-800 disabled:opacity-50"
        >
                ...
                {tablesDirty ? (
                  <div className="mt-2 flex items-center gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg bg-terracotta-700 px-3 py-1.5 text-xs font-semibold text-cream hover:bg-terracotta-800 disabled:opacity-50"
                    >
