...
export const EVENT_TYPES_FALLBACK: readonly EventTypeRow[] = [
  ...
  // 2026-06-12 owner batch (#1284) — the last three event_type_vocab keys gain
  // picker cards (active in the vocab but uncreatable before). Generic-dashboard
  // events like the other non-wedding types.
  { key: 'anniversary', label: 'Anniversary', emoji: '💞', enabled: true, onboardingHref: null, description: 'Another year of us.' },
  { key: 'graduation', label: 'Graduation', emoji: '🎓', enabled: true, onboardingHref: null, description: 'Caps off, future on.' },
  { key: 'reunion', label: 'Reunion', emoji: '🤝', enabled: true, onboardingHref: null, description: 'Together again.' },
];
