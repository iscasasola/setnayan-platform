 ...
 *
 * WHY: the customer doorway's 6-item mobile BottomNav (Home · Guests ·
 * Studio · Budget · Wedding · More) lands here when the host taps More.
 * This grid surfaces every event surface that ISN'T already one of those
 * five always-visible tabs — true overflow only.
 *
 * DE-DUPE (owner directive 2026-06-03 · "less stressful" pass): the
 * bottom-nav destinations (Home · Guests · Studio · Budget · Wedding) used
 * to render as cards here too, which contradicted this page's own "the rest
...
const DESCRIPTIONS: Record<string, string> = {
  // Top group (Explore — Studio + Home + Budget are bottom tabs)
  vendors:
    'Browse and discover vendors across every category. Filter by region, style, and budget to find your match.',

  // Plan group (Budget is a bottom tab)
  seating:
  ...
  // Design group (Website is the Wedding bottom tab)
  'mood-board':
    'Palette, location feel, and dress codes. The styling brain for the whole day.',
  monogram:
    'Craft your wedding monogram — your initials, a lockup style, and a live draw-on preview.',

  // Day-of group
  live: 'Run your live photo wall — mode override, screen codes, and guest-message approvals on the day.',
  'event-qr':
