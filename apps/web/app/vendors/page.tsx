...
export async function generateMetadata() {
  ...
  return {
    title,
    description: `Run your whole wedding business here free — import clients, get a search-ready website, get discovered. Free to join, 0% commission while we launch — then a flat 5% only on couples Setnayan brings you; your own clients always free. Solo ${p.soloMonthly}/28d · Pro ${p.proMonthly}/28d · Enterprise ${p.enterpriseMonthly}/28d.`,
    alternates: { canonical: '/vendors' },
    openGraph: {
      title,
      description: `Run your whole business here free · 0% commission while we launch, then a flat 5% only on couples we bring you · your own clients always free. Solo ${p.soloMonthly}/28d · Pro ${p.proMonthly}/28d.`,
      url: '/vendors',
      type: 'website',
      siteName: 'Setnayan',
    },
