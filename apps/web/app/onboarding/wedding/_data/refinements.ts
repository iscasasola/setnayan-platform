...
export const REFINEMENTS_DATA: RefineLeaf[] = [
  ...
  { key: 'photo_booth', label: 'Photo Booth', description: 'Instant keepsakes for your guests.', mainPhoto: MAIN('photo_booth'), options: opts('photo_booth', [['📸', 'Traditional'], ['🔄', '360 booth'], ['🎞️', 'GIF'], ['🖼️', 'Polaroid / instax'], ['🪞', 'Magic mirror']]) },
  ...
  { key: 'guest_shuttle', label: 'Guest Shuttle', description: 'Getting everyone there together.', mainPhoto: MAIN('guest_shuttle'), options: opts('guest_shuttle', [['🚐', '12-pax van'], ['🚌', '24-pax minibus'], ['🚍', '48-pax bus'], ['🚎', '30-pax coaster']]) },
