...
RECONNECT (`src-tauri/crates/encoder/src/reconnect.rs`): RTMP has no resume; a reconnect is a fresh
...
LOCAL RECORDING (`src-tauri/crates/encoder/src/file_sink.rs`): ONE tagger, TWO sinks. `FlvFileWriter`
