...
For every tier above that is 40 / 2 = 20 today. THREE WAYS TO GET THIS WRONG, ALL OF WHICH SHIP GREEN:

  ❌ HARD-CODING `20`. It silently becomes wrong the first time a tier is repriced. This is the exact
