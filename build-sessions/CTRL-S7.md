# S7 · Guest song request (SUP-52)

> **Model: Opus 5 · effort: medium.** Session S7 of the controller plan `build-sessions/CONTROLLER-PLAN-2026-09-18.md`.

Follow `~/Documents/Claude/Projects/setnayan-platform/build-sessions/HANDOFF-2026-09-18/PROMPTS/P7_small-and-honest.md` § 7a only. It is a connector, not a feature. Name both ends (the band's inbox and the DB half) with file paths **before** you write anything, and beware the two `RequestsInbox` components.
...
- **Your final message must end with:** `CONTROLLER ▸ S7 · <DONE|BLOCKED|NEEDS-OWNER> · PR #<n> <state> · <one line>`
