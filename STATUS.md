...
**2026-06-03 — wedding onboarding caters all faiths (0016/0043).** Owner ("fix all gaps… cater all different religious weddings"). Faith-adaptive ceremony venue — `ceremonyOptsFor(faith)` swaps the house of worship (Catholic/Christian→Church · INC→Chapel · Muslim→**Mosque** · Chinese→**Temple** · Cultural→outdoor/ancestral) + universal Garden/Beach/Civil/Same; two new matching photos generated via Recraft. De-churched copy ("A faith ceremony" / "Where will you hold your ceremony?" / venue blurb / groom role). The 6th faith **Chinese** is catered in the venue/copy logic; its activation (chips · allowlists · launch-status · migration `20260806000000`) shipped in parallel via **PR #889** — my overlapping code deduped on merge, my duplicate-timestamp migration dropped. `tsc --noEmit` exit 0.
