## 2026-07-02 · feat(vendor-services): coverage read layer + CRUD actions (rework PR 2)

Backend for the coverage-first Services rework (on top of the schema in `20270426250948`). Inert additive code — no UI consumer yet (lands in PR 3).
