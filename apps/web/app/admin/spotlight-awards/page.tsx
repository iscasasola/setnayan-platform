/**
 * /admin/spotlight-awards — Setnayan HQ · Spotlight Awards console (Wave 5).
 *
...
import { SpotlightRecomputeButton, SpotlightAwardRowActions } from './_components/spotlight-actions';

export const metadata = { title: 'Spotlight Awards · Setnayan HQ' };
...
export default async function SpotlightAwardsAdminPage({
  searchParams,
}: {
 ...
 */
import { addAwardManually } from './actions';
