// Ugat Studio surface — the body of the former brain page,
// re-homed 2026-07-10. actions/_components stay in /admin/brain; the legacy
...
export async function BrainSurface() {
  await requireAdmin();
