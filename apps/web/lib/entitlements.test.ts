...
// ── PAPIC_UNLOCK — "Unlock all of Papic" (₱15,000 · 2026-06-26). Grants six
// children (Kwento / Photo Wall / Thank You / Stories / Pabati / Camera Bridge).
// The uncapped-Unli-camera grant is a SEPARATE capture-gate bypass
// (papicUnliUnlockAllActive), NOT a child SKU here.
