 ...
 * approves at /admin/payments → the sku-activation hook increments
 ...
 * Extra seats are only ever > 0 for Enterprise (the buy flow is gated), so this
 * is a no-op for every other tier. `Infinity` base (should not occur post-2026-
 * 07-01, Enterprise is the finite 10) stays `Infinity`.
 */
