...
on 2026-08-29 — which may mean the switch is off, not that nobody wants it. The owner's switch audit
(P0-b) should have recorded the production value; if it is in the register, use it. If it is NOT,
apply autonomy rule 12: build behind the EXISTING flag, defaulted off, do NOT widen it, record the
open question. Do not stall waiting for an answer.
