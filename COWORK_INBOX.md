...
**Cross-ref:** corpus `DECISION_LOG.md` "Customer dashboard chrome RE-LOCKED" (2026-06-03) locks the model; this records the code landing of delta #3 (of 4 — remaining: Service+Add-ons merge).
