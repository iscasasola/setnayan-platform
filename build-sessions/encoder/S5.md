...
`src-tauri/src/encoder/contract.rs`, mirrored, tested for byte-equality of a fixture) so S6 can
...
Rust side (`src-tauri/src/encoder/mod.rs`): commands above, a bounded `tokio::sync::mpsc` (cap
