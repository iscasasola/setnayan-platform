...
export const PERSONA_PACKS: Record<string, TypePersonaPack> = {
  ...
  gender_reveal: {
    ...
    servicesByPersona: {
      ...
      modern_statement: ['live_background', 'animated_monogram'],
  ...
  corporate: {
    ...
    servicesByPersona: {
      ...
      modern_statement: ['live_background', 'panood', 'advanced_website'],
  ...
  tournament: {
    ...
    // Tournament leans broadcast-heavy: livestream the matches (panood),
