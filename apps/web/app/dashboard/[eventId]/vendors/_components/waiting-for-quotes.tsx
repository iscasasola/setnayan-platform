...
const WFQ_CSS = `
.wfq{--ink:var(--m-ink,#1E2229);--ink-soft:#4F535B;--mulberry:var(--m-mulberry,#1E2229);
...
.wfq .wfq-wait{font-family:var(--mono);font-size:9px;letter-spacing:.06em;text-transform:uppercase;
  color:var(--mulberry);background:rgba(30, 34, 41,.08);border-radius: var(--m-r-full);padding:4px 9px;white-space:nowrap}
