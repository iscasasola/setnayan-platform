    ...
    >
      ...
      {canOpenThread ? (
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 rounded-full border border-terracotta/40 bg-cream px-4 py-2 text-sm font-medium text-terracotta hover:border-terracotta"
        >
