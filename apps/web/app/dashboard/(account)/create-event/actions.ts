...
//
// Merge note (2026-06-14): #1284 added anniversary/graduation/reunion to the
// old hardcoded ALLOWED_TYPES; that array is retired by this DB-driven cutover,
// so those three are creatable purely by being active+enabled in
// event_type_vocab (set by #1284's migrations) — no code list to edit.
