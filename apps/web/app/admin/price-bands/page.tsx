...
/**
 * Legacy /admin/price-bands → studio redirect (Money split · 2026-07-10). The surface
 * now lives at /admin/pricing?tab=price-bands; its body was re-homed into a _surfaces/*
