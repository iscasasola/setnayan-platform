// Money-split studio surface — the body of the former settings page,
// re-homed here (2026-07-10). actions/_components stay in /admin/settings; the
...
import { SentrySmokeTestButton } from '@/app/admin/settings/_components/sentry-smoke-test-button';
 ...
 */
export async function SettingsSurface({ searchParams }: Props) {
  await requireAdmin();
