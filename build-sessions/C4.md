...
business and an item may NOT. Build behind the existing flag. If P0-b recorded the production value,
use it; if not, apply autonomy rule 12 — build behind the flag, defaulted off, record the question,
do not stall.
