...
/**
 * Legacy /admin/notifications → studio redirect (Money split · 2026-07-10). The surface
 * now lives at /admin/settings?tab=notifications; its body was re-homed into a _surfaces/*
