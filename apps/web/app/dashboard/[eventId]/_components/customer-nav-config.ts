  ...
  return [
    {
      ...
      items: [
        ...
        {
          // Alaala — the living-memory hub (Lane 2 of the Alaala embed). The
          // narrative "story" view of the memory pillar the Studio "store"
          // sells into. Sits in the Setnayan group beside Studio; placement
